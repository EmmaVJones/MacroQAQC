...
# Test real data 
realSites <- read_csv('fromRick/QAissues/2019 Pond QAQC 4_1_21.csv')#realData/2019 Pond QAQC_EVJ3ways.csv')#read_csv('fromRick/realData/template (19).csv')#read_csv('fromRick/realData/2019 Pond QAQC.csv')#read_csv('fromRick/realData/2020QA_EVJ.csv')# %>%
  # for testing
